...
import by.bntu.fitr.povt.javanutie.utilits.Initializer;
...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        println(Arrays.toString(Initializer.values()));
        type = nextLine("Enter type: ");
        initializer = Initializer.valueOf(type);
        String filename = nextLine("Enter filename: ");
        initializer.read(filename, basket);
...
//        println(test);
        ...
        type = nextLine("Enter type: ");
        initializer = Initializer.valueOf(type);
        filename = nextLine("Enter filename: ");
        initializer.write(filename, basket);
    }
